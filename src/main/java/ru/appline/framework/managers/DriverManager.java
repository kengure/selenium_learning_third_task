...
public class DriverManager {
     ...
     *
     * @param gecko  - переменная firefox из файла application.properties в классе
     *               {@link ru.appline.framework.utils.PropConst}
     * @param chrome - переменная chrome из файла application.properties в классе
     *               {@link ru.appline.framework.utils.PropConst}
     */
